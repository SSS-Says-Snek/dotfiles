-- hyprland.lua — Migrated from hyprland.conf (Hyprland 0.55 Lua config)
-- See https://wiki.hypr.land/Configuring/Start/
-- Remove the autogenerated line below once you've verified this config:
...
hl.config({
    ...
    decoration = {
        ...
        -- Shadow is disabled (commented out in original):
        -- shadow = {
        --     enabled      = true,
        --     range        = 4,
        --     render_power = 3,
...
---- PLUGIN ----
-----------------------
-- NOTE: hyprwinwrap plugin config — check if hyprwinwrap has updated its
-- Lua API for 0.55. The block below is a best-effort translation.
-- You may need to consult hyprwinwrap's own documentation/repo.
-- hl.config({
--     plugin = {
--         hyprwinwrap = {
--             class = "kitty-bg",
